...
// Redux
import { saveData, deleteData, closeCreating, addNewContacto } from '../../../context/contactoCSlice'; //EDITABLE: MAIN
...
function ContactosCreateC() { //EDITABLE

    // --------------- Redux store settings -------------------------------------------------------

    const dispatch = useDispatch();
    const contactoClienteCData = useSelector(state => state.contactoC.ContactoCreate); // EDITABLE
    ...
    useEffect(() => {
        if (contactoClienteCData) { // EDITABLE
            setSelectedTipoContacto(contactoClienteCData.selectedTipoContacto || null); // EDITABLE
            setSelectedIdioma(contactoClienteCData.selectedIdioma || null); // EDITABLE
            setisAnyEmpty(contactoClienteCData.isAnyEmpty || false); // EDITABLE
            setNewContacto(contactoClienteCData.newContacto || defaultNewContacto); // EDITABLE
            setRequiredFields(contactoClienteCData.requiredFields || defaultRequiredFields); // EDITABLE
        }
    ...
    const handleCreate = async (e) => {
        ...
        dispatch(addNewContacto(newContacto));
        handleCancel();
...
export default ContactosCreateC;