...
const API_BASE_URL = `${apiEndpoint}/RolPago`;
...
function RolesTable(props) {
    ...
    const { data: roles, error, isValidating, isLoading, mutate: refresh } = useSWR(API_BASE_URL, fetcher, {
    ...
    const initFilters = () => {
        setFilters({
            ...
            rolPagoId: { value: null, matchMode: FilterMatchMode.EQUALS },
            anoGeneracion: { value: null, matchMode: FilterMatchMode.EQUALS },
            mesGeneracion: { value: null, matchMode: FilterMatchMode.EQUALS },
            fechaCreacion: { value: null, matchMode: FilterMatchMode.EQUALS },
        }); // EDITABLE
    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-content-between">
                ...
                <div className="table-utility">
                    <span style={{ alignSelf: 'center', fontWeight: '400' }}><strong>Registros:</strong> {roles ? roles.length : '0'}</span>
                </div>
            </div>
        );
    ...
    const columnsData = [
        ...
        {
            nombrevar: "anoGeneracion",
            header: "Año generación",
            filterPlaceholder: "Buscar por tipo de empleado",
        },
        {
            nombrevar: "mesGeneracion",
            header: "Mes generación",
            filterPlaceholder: "Buscar por concepto",
        },
        {
            nombrevar: "usuario.correoElectronico",
            header: "Usuario",
            filterPlaceholder: "Buscar por año",
        },
        {
            nombrevar: "fechaCreacion",
    ...
    const onRowSelect = (event) => {
        props.onSelect(event.data.rolPagoId); // EDITABLE
    ...
    return (
        <div className="tabla">
            ...
            <DataTable
                ...
                header={header}
                emptyMessage="No se encontraron roles de pago" // EDITABLE
