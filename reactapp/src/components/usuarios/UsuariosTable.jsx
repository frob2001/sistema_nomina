...
function UsuariosTable(props) {
    ...
    const { data: usuarios, error, isValidating, isLoading, mutate: refresh } = useSWR(API_BASE_URL, fetcher, {
    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-content-between">
                ...
                <div className="table-utility">
                    <span style={{ alignSelf: 'center', fontWeight: '400' }}><strong>Registros:</strong> {usuarios ? usuarios.length : '0'}</span>
                </div>
            </div>
        );
