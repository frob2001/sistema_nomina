...
const API_BASE_URL = `${apiEndpoint}/TiposEstados`;

// Auth
import { useMsal } from '@azure/msal-react';

const useTiposEstados = () => {
    ...
    const fetcher = async (url) => {
        ...
        // Ordenar los datos basándose en tipoEstadoId como un entero
        data.sort((a, b) => parseInt(a.tipoEstadoId, 10) - parseInt(b.tipoEstadoId, 10));
